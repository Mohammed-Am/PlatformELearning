...
<head>
    <meta charset="utf-8">
    <title>ECOURSES - Cours en ligne </title>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav py-0">
                            ...
                            <a href= "course.php" class="nav-item nav-link active">Cours</a>
        ...
        <div class="container py-5">
            ...
            ?>
                    <div class="mb-5 p-28">
                        ...
                        <div style=' display: grid; place-items: center; margin-bottom:15px;'>
                            <img class=" img-fluid" style="width: 90%; height: 32vw; object-fit: cover; border-radius:15px; " src="image/<?= $row['image'] ?>" alt="Image">
                        </div>
                        <p class="font-weight-bold " style="font-size:20px"> <?= $row['bref'] ?></p>
                        
                        <h2 >Prérequis</h2>
                        <p class="font-weight-bold" style="font-size:20px"> <?= $row['Prerequis'] ?></p>
                        
                        <h2 >La description</h2>
                        <p  class="font-weight-bold" style="font-size:20px"> <?= $row['description'] ?></p>
                        
                        <h2 >À qui ce cours s'adresse-t-il ?</h2>
                        <p class="font-weight-bold" > <ul style="font-size:19px">
                                 <?= $row['qui'] ?>
                        </ul></p>

                        <div class="d-flex justify-content-center">
                        <a href="<?= $row['url'] ?>" target="_blank"><button type="button" class="btn   btn-lg btn-block btn-primary " >Show this Cours</button></a>
                        </div>
