            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <img class="img-fluid rounded w-100 mb-4" src="./assest/img/carousel-1.jpg" alt="Image">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="media mb-4">
                            <img src="./assest/img/user.jpg" alt="Image" class="img-fluid rounded-circle mr-3 mt-1"
                                style="width: 45px;">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex flex-column text-center bg-dark rounded mb-5 py-5 px-4">
                        <img src="./assest/img/user.jpg" class="img-fluid rounded-circle mx-auto mb-3" style="width: 100px;">
                    ...
                    <div class="mb-5">
                        ...
                        <a class="d-flex align-items-center text-decoration-none mb-3" href="">
                            <img class="img-fluid rounded" src="./assest/img/blog-80x80.jpg" alt="">
                            <div class="pl-3">
